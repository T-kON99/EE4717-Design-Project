<?php
    ...
    class Test extends UnitTest {
        ...
        function test() {
            $res_html = post_request('http://localhost:3000/php/login.php', array("email" => $this->email, "password" => $this->password));
            return strpos($res_html, '<title>Home</title>') ? $this->FAILED : $this->SUCCESS;
        }
